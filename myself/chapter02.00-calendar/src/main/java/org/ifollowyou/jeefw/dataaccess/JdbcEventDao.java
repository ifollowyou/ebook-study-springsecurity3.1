package org.ifollowyou.jeefw.dataaccess;
...
import org.ifollowyou.jeefw.domain.CalendarUser;
import org.ifollowyou.jeefw.domain.Event;
...
public class JdbcEventDao implements EventDao {
    ...
    public List<Event> getEvents() {
        return jdbcOperations.query(EVENT_QUERY+" order by evt.id;", EVENT_ROW_MAPPER);
    }
    ...
    private static final String EVENT_QUERY = "select evt.id, evt.summary, evt.description, evt.time, " +
            ...
            "from events as evt, calendar_users as owner, calendar_users as attendee " +
            "where evt.owner = owner.id and evt.attendee = attendee.id";
}
